...
/**
 * Class n00017_submitted_assessment
 * 
...
class n00017_submitted_assessment
{
    public function up()
    {
        ...
        $SQL = "CREATE TABLE submitted_assessment ( 
            ...
            `submitted` VARCHAR(30) NULL DEFAULT NULL,
            `marked` VARCHAR(30) NULL DEFAULT NULL,
    ...
    {
        $db = \core\Application::$app->db;
        $SQL = "DROP TABLE submitted_assessment";
        $db->_dbh->exec($SQL);
    }
}
